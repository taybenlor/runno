(component
  (type $var-def (variant (case "empty") (case "num" u32) (case "text" string) (case "big" f64)))
  (import "type-var" (type $var (eq $var-def)))
  (import "echo" (func $echo (param "v" $var) (result $var)))
  ...
  (core module $m
    (import "env" "echo"
      (func $echo (param i32 i64 i32 i32)))
  ...
  (func (export "run") (param "v" $var) (result $var)
