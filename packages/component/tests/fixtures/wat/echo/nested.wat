(component
  (type $kind-def (variant (case "a") (case "b" s32)))
  (import "type-kind" (type $kind (eq $kind-def)))
  (type $item-def (record (field "id" u64) (field "tags" (list string)) (field "kind" $kind)))
  (import "type-item" (type $item (eq $item-def)))
  (type $t (list $item))
