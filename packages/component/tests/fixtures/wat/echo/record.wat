(component
  (type $rec-def (record (field "count" u32) (field "label-text" string) (field "ratio" f64)))
  (import "type-rec" (type $rec (eq $rec-def)))
  (import "echo" (func $echo (param "v" $rec) (result $rec)))
  ...
  (core module $m
    (import "env" "echo"
      (func $echo (param i32 i32 i32 f64 i32)))
    (import "env" "realloc" (func $realloc (param i32 i32 i32 i32) (result i32)))

    (func (export "run") (param i32 i32 i32 f64) (result i32)
      (local $ret i32)
      (local.set $ret
        (call $realloc (i32.const 0) (i32.const 0)
          (i32.const 8) (i32.const 24)))
      local.get 0
      local.get 1
      local.get 2
      local.get 3
  ...
  (func (export "run") (param "v" $rec) (result $rec)
